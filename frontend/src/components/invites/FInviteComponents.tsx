...
function FInviteComponent({ inviterName, onAccept, onDecline }) {
  return (
    <div className='rounded-md bg-slate-50 w-full max-w-[1000px] space-y-2 p-3'>
      <div className='text-slate-800'>{inviterName} wants to be friends!</div>
...
export default FInviteComponent;