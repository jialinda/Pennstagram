...
function InviteComponent({ inviteeName = 'Joanna', chatroomName = 'NETS2120', onAccept, onDecline }) {
  return (
    <div className='rounded-md bg-slate-50 w-full max-w-[1000px] space-y-2 p-3'>
      <div className='text-slate-800'>{inviteeName} invited you to {chatroomName} Chat</div>
